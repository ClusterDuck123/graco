...
class Calculate:
    ...
    def coefficients(G, dtype=pd.DataFrame):
        ...
        GCV = pd.DataFrame({
            ...
            ('A', '1', '8')  : 1*GDV['8']  / (1*GDV['4'] + 2*GDV['8'] + 1*GDV['10'] + 2*GDV['13']),
            ('A', '1', '10') : 1*GDV['10'] / (1*GDV['4'] + 2*GDV['8'] + 1*GDV['10'] + 2*GDV['13']),
            ('A', '1', '13') : 1*GDV['13'] / (1*GDV['4'] + 2*GDV['8'] + 1*GDV['10'] + 2*GDV['13']),
            ...
            ('A', '3', '12') : 1*GDV['12'] / (1*GDV['9'] + 2*GDV['12'] + 3*GDV['14']),
            ('A', '3', '14') : 1*GDV['14'] / (1*GDV['9'] + 2*GDV['12'] + 3*GDV['14']),
