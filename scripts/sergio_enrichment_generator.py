...
def main(in_parms):
    ...
    # Keep only annotated genes in cluster
        ...
        enrichments.to_csv("/Users/markusyoussef/Desktop/git/supplements/data/"
                           "processed_data/yeast/sergio_enrichments/"
        f"{in_parms.network_name}/{in_parms.feature}/{in_parms.metric}/{in_parms.aspect}/{RUN}_{n_clusters}.csv")
...
features = {'GDV'} #'GCV-all', 'GCV-O+', 'triangle'}
